...
class OpenAIProvider(ProviderBase):
    ...
    def count_tokens(
        ...
        *,
        ...
        model_ref : str | None, default=None
            OpenAI model identifier used with ``input_data``.
        ...
        request : OpenAICountTokensRequest | None, default=None
            Validated OpenAI request payload. When provided, ``input_data`` and
    ...
    def _count_request_tokens(
        ...
        *,
        ...
        """Count tokens for a pre-validated OpenAI request payload.
